...
public class Logsscriptcreateticket extends Basetest 
{
	//this script includes creating the ticket from admin,agent,client
	//creating the ticket
	@Test(priority=1)
	...
	{	
        ...
        //create a ticket from the client panel
		@Test(priority=3)
